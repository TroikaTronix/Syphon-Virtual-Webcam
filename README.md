...
> [!WARNING]
> This project is no longer compatible with macOS Sonoma (v14.x) or later due to additional operating-system security restrictions. It is therefore no longer maintained or supported.
