...
**Note: This project is no longer compatible macOS Sonoma (v14.x) or later due to additional operating-system security restrictions. It is therefore is no longer maintained or supported.**
